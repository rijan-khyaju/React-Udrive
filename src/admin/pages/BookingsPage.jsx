...
export default function BookingsPage() {
  const { bookings, loading, error, updateBooking, refreshBookings } = useBookings();
    ...
    <section className="admin-page admin-bookings">
      ...
      {loading ? (
        ...
        <div className="admin-card admin-card-large">
          ...
          <p className="error-message">{error.message || 'Unable to load bookings.'}</p>
          <button className="btn-secondary" type="button" onClick={refreshBookings}>Retry</button>
        </div>
      ) : (
        <div className="admin-card admin-card-large">
          <div className="admin-card-header">
          ...
          <DataTable
            columns={['Booking ID', 'Student Name', 'Course', 'Booking Date', 'Time', 'Payment Status', 'Booking Status', 'Actions']}
